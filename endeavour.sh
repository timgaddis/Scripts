...
sudo pacman -S --noconfirm --needed yay conky jq lynx python-lxml mate-calc cmake eog eog-plugins unace arj expac yajl p7zip gparted gnome-font-viewer gedit numlockx gnome-keyring xdg-desktop-portal-gtk evince yt-dlp ffmpegthumbnailer
pause_function

#print_title "Setup Bluetooth apps"
...
sudo pacman -S --noconfirm --needed plank keepassxc wine vlc vlc-plugins-all qbittorrent steam inkscape borg gimp telegram-desktop vorta pan proton-vpn-gtk-app
pause_function
...
print_title "Install and start Jellyfin"
yay -S --noconfirm --needed jellyfin-server jellyfin-web
...
# yay -S --noconfirm --needed arc-gtk-theme-git
#sudo pacman -S --noconfirm --needed gtk-engine-murrine elementary-icon-theme
# flat-remix flat-remix-gtk xcursor-simp1e-adw
mkdir sound
cd sound
