...
sudo pacman -R parcellite xed

sudo pacman -Syy

print_title "Install system apps"
sudo pacman -S conky jq gksu lynx python-lxml mate-calc gconf-editor nvidia nvidia-utils xorg-server-devel opencl-nvidia lib32-nvidia-utils grub-customizer gedit trizen
pause_function
...
sudo pacman -S plank deja-dup keepassxc wine qbittorrent pan gimp-plugin-lqr gimp-plugin-gmic gimp-plugin-fblur gimp-refocus gimp-nufraw flashplugin vocal chromium pepper-flash steam playonlinux
pause_function
