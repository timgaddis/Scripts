...
pacaur -S rar gpodder3 spideroak-one polly pypar2 grub-customizer plex-media-server gimp-paint-studio gimp-plugin-pandora
pause_function

print_title "Install programming apps"
pacaur -S google-cloud-sdk gitg jdk nodejs sqlitebrowser npm
pause_function
